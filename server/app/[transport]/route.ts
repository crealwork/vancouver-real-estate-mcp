      ...
      async () => {
        ...
        return text(
          [
            ...
            "- Some areas have holes in the published record. GVR only serves",
            "  packages back to 2018-12; earlier months come from archived copies and",
            "  run intermittently from 2012-07, so a given month before 2019 may be",
            "  missing at neighbourhood level. GVR also withdrew its January and",
